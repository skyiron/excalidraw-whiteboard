...
export class Store {
  ...
  public filterUncomittedElements(
    ...
    // Make sure to sync invalid indices in case the uncomitted element was restored from the snapshot
    return arrayToMap(syncInvalidIndices(Array.from(nextElements.values())));
  }
